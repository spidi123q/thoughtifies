            ...
            <md-content layout="row" flex="60">
                    <md-content ng-hide="view" flex ui-scroll-viewport scroll-glue>
                          <md-list>
                                ...
                                <img ng-if="dpDisplay.get(item)" image-fetch ng-src="{{myDp}}" size="60" class="md-avatar" alt="{{todos[0].who}}" />
                                <img ng-if="!dpDisplay.get(item)" image-fetch ng-src="{{msgUserName.picture}}" size="60" class="md-avatar" alt="{{todos[0].who}}" />
